...
a%daptive signal controllers that virtually nullify the impact on
conventional traffic of installing light rail.  To this end, the use
of such controllers could
%substantially
%mitigate concerns of the impact of light rail on conventional
%traffic networks and
remove this critical public concern regarding the implementation of
future light rail systems with the potential to positively impact the
