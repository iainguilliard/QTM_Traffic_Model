...
demonstrate the power and potential optimizing fixed-time control
schedules subject to light rail constraints to use with existing
traffic signal controllers and enable a novel future generation of
optimized adaptive signal controllers that virtually nullify the
impact of the light rail presence.  This mitigates the concern of the
impact of light rail on conventional traffic networks and removes this
critical obstacle to the implementation of future light rail systems
that positively impact the environment, urban traffic congestion, and
commute times for both conventional traffic and public transit riders.
