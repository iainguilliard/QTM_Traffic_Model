...
signal control approaches to optimize fixed-time control schedules for
...
adaptive signal controllers that virtually nullify the impact of light
rail presence.  The use of such controllers would substantially
mitigate the concern of the impact of light rail on conventional
traffic networks and remove this critical obstacle to the
implementation of future light rail systems that positively impact the
environment, urban productivity, and commute time reductions for both
conventional traffic and public transit riders.
