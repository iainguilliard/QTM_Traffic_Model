...
\centering
%  trim={<left> <lower> <right> <upper>}
\includegraphics[trim={0 10 0 2},width=0.47\textwidth]{Transit1_sched.pdf}
...
For each evaluation we first generate a signal plan using QTM configured as either an optimized adaptive controller or a fixed-time controller. \TMAX is set sufficiently high to allow all traffic to clear the network,
...
%  trim={<left> <lower> <right> <upper>}
%
\subfigure[]{\label{fig:nwrwork1_slow:hist:arterial}
\includegraphics[keepaspectratio,width=0.28\textwidth]{network1_hist_slow_arterial.pdf}}
\subfigure[]{\label{fig:network1_slow:hist:side}
\includegraphics[keepaspectratio,width=0.2\textwidth]{network1_hist_slow_side.pdf}}
\subfigure[]{\label{fig:network1_slow:hist}
\includegraphics[keepaspectratio,width=0.2\textwidth]{network1_hist_slow.pdf}}
\subfigure[]{\label{fig:network2_slow:hist:}
\includegraphics[keepaspectratio,width=0.2\textwidth]{network2_hist_slow.pdf}}
%
\subfigure[]{\label{fig:nwrwork1_fast:hist:arterial}
\includegraphics[keepaspectratio,width=0.28\textwidth]{network1_hist_fast_arterial.pdf}}
\subfigure[]{\label{fig:network1_fast:hist:side}
\includegraphics[keepaspectratio,width=0.20\textwidth]{network1_hist_fast_side.pdf}}
\subfigure[]{\label{fig:network1_fast:hist}
\includegraphics[keepaspectratio,width=0.20\textwidth]{network1_hist_fast.pdf}}
\subfigure[]{\label{fig:network2_fast:hist}
\includegraphics[keepaspectratio,width=0.20\textwidth]{network2_hist_fast.pdf}}
\vspace{-5mm}
...
\begin{figure*}[t!] \centering
%  trim={<left> <lower> <right> <upper>}
\subfigure[]{\label{fig:network1_microsim:fixed_side}
\includegraphics[keepaspectratio,width=0.49\textwidth]{network1_microsim_fixed_slow_side.pdf}}
\subfigure[]{\label{fig:network1_microsim:opt_side}
\includegraphics[keepaspectratio,width=0.49\textwidth]{network1_microsim_opt_slow_side.pdf}}
\subfigure[]{\label{fig:network1_microsim:fixed_side}
\includegraphics[keepaspectratio,width=0.49\textwidth]{network1_microsim_fixed_slow_arterial.pdf}}
\subfigure[]{\label{fig:network1_microsim:opt_side}
\includegraphics[keepaspectratio,width=0.49\textwidth]{network1_microsim_opt_slow_arterial.pdf}}
