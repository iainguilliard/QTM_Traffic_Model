...
%
Slow
\subfigure[]{\label{fig:network1_slow:hist:arterial}
...
%
\subfigure[]{\label{fig:nerwork1_fast:hist:arterial}
...
\vspace{-5mm}
\caption{Impact of light rail on number of stops for each Network.}
