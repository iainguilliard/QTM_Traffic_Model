...
\includegraphics[keepaspectratio,width=0.3\textwidth]{network1_hist_slow.pdf}}
\subfigure[]{\label{fig:nwrwork1_slow:hist:arterial}
\includegraphics[keepaspectratio,width=0.3\textwidth]{network1_hist_slow_arterial.pdf}}
\subfigure[]{\label{fig:network1_slow:hist:side}
\includegraphics[keepaspectratio,width=0.3\textwidth]{network1_hist_slow_side.pdf}}
%
\vspace{-5mm}
...
\includegraphics[keepaspectratio,width=0.3\textwidth]{network1_hist_fast.pdf}}
\subfigure[]{\label{fig:nwrwork1_fast:hist:arterial}
\includegraphics[keepaspectratio,width=0.3\textwidth]{network1_hist_fast_arterial.pdf}}
\subfigure[]{\label{fig:network1_fast:hist:side}
\includegraphics[keepaspectratio,width=0.3\textwidth]{network1_hist_fast_side.pdf}}
%
\vspace{-5mm}
...
\includegraphics[keepaspectratio,width=0.3\textwidth]{network2_hist_fast.pdf}}
