...
\includegraphics[width=0.45\textwidth,trim={1.3cm 1.2cm 3cm 0.5cm},clip]{canberra_transit.pdf}}
\subfigure[]{
\label{subfig:example}
%\includegraphics[width=0.45\textwidth,trim={0cm 0cm 0cm 0cm},clip]{map_example.png}
\hspace{-3mm}\includegraphics[width=0.50\textwidth,trim={0cm 0cm 0cm 0cm},clip]{pw_queues_homogenous.pdf}
\vspace{-2mm}
}
...
\begin{cAlign}
%
\Omit{\textstyle} \sum_{k=1}^{\Pn} \p{\ell}{k} &= 1\tagconstrain{c:onlyOnePhaseOn}\\
%
