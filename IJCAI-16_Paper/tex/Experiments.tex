...
networks.
%
Box plots representing the observed distribution of delay for 3
different values of demand for each network (c,d).
%
...
arterial $q_2$ to $q_{13}$ in Network 1 with the slow light rail schedule.
%
