...
adaptive control compared to fixed-time control with the introduction of light
rail, assuming the fixed-time control was used before the light rail
introduction.
%
The optimized adaptive control is able to mitigate the impact of the light rail
introduction and allows the networks to be used by almost the same demand level
as before without increasing the average delay.
%
In particular, for the fast light rail, the optimized adaptive controller allows
5\% (arterial) and 0.5\% (grid) increase in demand without additional average
delay.
