...
\newcommand{\comment}[1]{}
\newcommand{\revision}[2]{\protect\marginnote{\color{cyan}\textbf{[R#2]}\color{black}} \color{red}#1\color{black}} \newcommand{\revout}[1]{\color{red}\sout{#1}\color{black}}
\newcommand{\revinout}[3]{\protect\marginnote{\color{cyan}\textbf{[R#3]}\color{black}}\color{red}#1\sout{#2}\color{black}}
...
%\renewcommand{\revision}[2]{#1}
%\renewcommand{\revout}[1]{}
%\renewcommand{\revinout}[3]{#1}
