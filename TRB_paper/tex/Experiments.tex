...
\caption{(a) Receding horizon control. In this example, the problem
  ...
  (b) The two discretizations used in the experiments, shown with a major frame duration of 40s.
  From the end of the minor frame time,
  Non-homogeneous $\Delta t$ 1, $\Delta t$ is linearly interpolated from 0.25 to 0.5 over 10s, and Non-homogeneous $\Delta t$ 2, $\Delta t$ is linearly interpolated from 0.25 to 1.0 over 10s. $\Delta t$ is then held constant to the end of the major frame time}
\label{fig:multiplan}
\end{figure*}
