...
\caption{(a),(b),(c) Networks used in the evaluation of the QTM. (d) Cumulative arrival and departure curves for lane $q_1\to q_3\to q_6 \to q_9$ on network 2. \remark{Iain: please,
