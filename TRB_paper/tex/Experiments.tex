...
%
the quality of the solution and convergence to the optimal solution.
%
...
\caption{Receding horizon control. In this example, the problem horizon \TMAX
...
frame to 3000s for the receding horizon approaches and unbounded for the optimal
plan.
%
