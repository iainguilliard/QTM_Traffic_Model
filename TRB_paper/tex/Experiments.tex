...
the
maximum flow rate between queues, \FMAX{i}{j},  is set at 5 cars per second. 
Each 
...
and then simulate the flow with the QTM LP formulation. \fnremark{Do we need 
to justify why we use the QTM as the simulator over say a micro simulator?}
