...
\caption{(a) Receding horizon control. In this example, the problem
  ...
  \revision{(b) The two non-homogeneous discretizations used in the experiments, shown with a major frame duration of 40s.
  From the end of the minor frame time, $\Delta t$ is linearly interpolated over 10s from 0.25 to 0.5 
  for Non-homogeneous $\Delta t$ 1, and 0.25 to 1.0 for Non-homogeneous $\Delta t$ 2. 
...
%
For the non-homogeneous experiments, \revision{we linearly increase \DT[] from the end of the minor
...
Non-homogeneous $\Delta t$ 1 from 0.25 to 0.5, and Non-homogeneous $\Delta t$ 2
from 0.25 to 1.0. For a given $\Nn > 40$, the major frame size used by the non-homogeneous approach
is $10.375 + 1.25(\Nn-40)$ seconds for Non-homogeneous $\Delta t$ 1, and 
$10.375 + 0.625(\Nn-40)$ seconds for Non-homogeneous $\Delta t$ 2. }{1.2}
%
