...
network.\remark{Now that we have plenty of space for figures, is Fig (d) here
still necessary?}}
\label{fig:networks}
\end{figure*}
...
\includegraphics[keepaspectratio,height=0.31\textwidth]{network_1_converge.pdf}}
\subfigure[]{
...
\includegraphics[keepaspectratio,height=0.31\textwidth]{network_2_converge.pdf}}
\subfigure[]{
...
\includegraphics[keepaspectratio,height=0.31\textwidth]{network_3_converge.pdf}}
\subfigure[]{
