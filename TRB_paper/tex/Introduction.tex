...
to heuristic search~\trbcitenum{lo1999dynamic,he2010heuristic}
\revision{to store and forward with pressure control~\trbcitenum{varaiya2013max} }{4.6} to
\revinout{schedule driven control}{scheduling}{4.6}~\trbcitenum{xie2012schedule,smith2013surtrac} to reinforcement
