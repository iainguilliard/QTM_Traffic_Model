...
\item  unlike previous joint intersection control
  work~\trbcitenum{lo1998novel,lin2004enhanced,han2012link}, it is
...
\item any length of roadway with no merges or diverges can be modeled
  ...
  intersections), and
%
\item it accurately models fixed travel time delays critical to green
  wave coordination as
  in~\trbcitenum{gartner1974optimization,gartner2002arterial,he2011pamscod}
  through the use of a non-first order Markovian
  update\remark{\footnote{\remark{This is not explicitly mentioned later on}}}
  model and combines this with the more global intersection signal
...
\fnremark{Paper should follow the basic progression outlined in last paragraph above.
