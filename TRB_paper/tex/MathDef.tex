...
\newcommand{\TMAX}{\ensuremath{T^{MAX}}}
...
\newcommand{\f}[3][n]{f_{#2\shortrightarrow#3,#1}}

\ifdefined\newinoutflow
\newcommand{\inq}[2][n]{f_{in\shortrightarrow#2,#1}}
\newcommand{\outq}[2][n]{f_{#2\shortrightarrow out,#1}}
\else
\newcommand{\inq}[2][n]{in_{#2,#1}}
\newcommand{\outq}[2][n]{out_{#2,#1}}
\fi
...
\ifdefined\newinoutflow
\newcommand{\QIN}[1]{\mathrm{F}_{in\shortrightarrow#1}}
\newcommand{\QOUT}[1]{\mathrm{F}_{#1\shortrightarrow out}}
\else
\newcommand{\QIN}[1]{\mathrm{Q}_{#1}^{\mathrm{in}}}
\newcommand{\QOUT}[1]{\mathrm{Q}_{#1}^{\mathrm{out}}}
\fi

\newcommand{\QDELAY}[1]{\mathrm{T}_{#1}^{\mathrm{prop}}}
\newcommand{\FMAX}[2]{\mathrm{F}_{#1\shortrightarrow#2}}
\newcommand{\FTURN}[2]{\mathrm{Pr}_{#1\shortrightarrow#2}^{\mathrm{}}}
