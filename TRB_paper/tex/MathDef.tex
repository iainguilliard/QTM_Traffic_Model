...
\newcommand{\Prvec}{\ensuremath{\vec{Pr}}}
...
\newcommand{\f}[3][n]{\ensuremath{f_{#2\shortrightarrow#3,#1}}}

\ifdefined\newinoutflow
\newcommand{\inq}[2][n]{\ensuremath{f_{in\shortrightarrow#2,#1}}}
\newcommand{\outq}[2][n]{\ensuremath{f_{#2\shortrightarrow out,#1}}}
\else
\newcommand{\inq}[2][n]{\ensuremath{in_{#2,#1}}}
\newcommand{\outq}[2][n]{\ensuremath{out_{#2,#1}}}
\fi
...
\newcommand{\vecDT}{\ensuremath{\vec{\Delta t}}\xspace}
