...
non-homogeneous time intervals \remark{because \DT[n] and \DT[n-1] might not be
aligned}.
%
\remark{\footnote{FWT: I removed the constraint $\q{i} \le
\frac{\DT[n]}{\DT[m]}\qin[m]{i} - \qout{i}$ because it seems to be subsumed by
\eqref{c:qUpdate}}}
%
...
In order to account for the \remark{misalignment} of the different \DT[], we
need to find the volume of traffic that was able to arrive at queue $i$,
traverse it (i.e., wait \QDELAY{i} seconds), and reach the stop line before
\DT[n] is over.
%
...
\tn[m+1]$.\remark{\footnote{FWT: find a good place to define $t_n$ as
$\sum_{i=1}^{n}\DT[i]$}}
%
...
\includegraphics[width=.01\textwidth,trim={0cm 0cm 0cm 0cm},clip]{convergence.pdf}
}
\subfigure[]{
\label{subfig:converg_b}
\includegraphics[width=.01\textwidth,trim={0cm 0cm 0cm 0cm},clip]{convergence_vari.pdf}
}
...
\includegraphics[width=.01\textwidth,trim={0cm 0cm 0cm 0cm},clip]{convergence_NH.pdf}
...
\subfigure[]{
\label{subfig:test1}
\includegraphics[width=0.045\textwidth,trim={0cm 0cm 0cm 0cm},clip]{phase_plot_fig_1.pdf}}
\subfigure[]{
\label{subfig:test2}
\includegraphics[width=0.045\textwidth,trim={0cm 0cm 0cm 0cm},clip]{phase_plot_fig_2.pdf}}
\subfigure[]{
\label{subfig:test3}
\includegraphics[width=0.045\textwidth,trim={0cm 0cm 0cm 0cm},clip]{phase_plot_fig_3.pdf}}
\subfigure[]{
\label{subfig:test4}
\includegraphics[width=0.045\textwidth,trim={0cm 0cm 0cm 0cm},clip]{phase_plot_fig_4.pdf}}
