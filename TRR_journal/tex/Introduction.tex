...
\emph{optimized} controllers \revision{(that incorporate elements of both adaptive and actuated control) }{4.1} as evidenced in a variety of approaches
\revinout{including}{ranging from}{4.6} mixed integer (linear)
programming~\trbcitenum{gartner1974optimization,gartner2002arterial,lo1998novel,he2011pamscod,lin2004enhanced,han2012link},
heuristic search~\trbcitenum{lo1999dynamic,he2010heuristic},
queuing delay with pressure control~\trbcitenum{varaiya2013max} 
and linear program control~\trbcitenum{li2014coupled}, to
\revinout{scheduling-driven control}{scheduling}{4.6}~\trbcitenum{xie2012schedule,smith2013surtrac},
and reinforcement
...
methods in the spirit of~\trbcitenum{lo1998novel,lin2004enhanced}
\revout{~\trbcitenum{han2012link}} that
...
\includegraphics[width=0.5\textwidth,trim={0cm -4cm 0cm 0cm},clip]{map_overlay.jpg}
}
\subfigure[]{
...
\item  Unlike previous CTM-based joint intersection signal 
  optimization~\trbcitenum{lo1998novel,lin2004enhanced}\revout{\trbcitenum{han2012link}}{}, the QTM is
...
\revision{Further, the free flow travel time of a link can be modeled exactly,
independent of the discritizaiton time step, while CTM requires a further increased
discretization to approach the same resolution.}{2.2}
%
