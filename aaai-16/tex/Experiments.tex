...
We evaluate each network using the fixed control and the optimized adaptive
...
%
%(we omit the case of using optimized adaptive before the light rail and fixed
