...
rail even when their timings are optimized to sychronize with
...
%it is critical to mitigate the impact
%of light rail on existing traffic congestion.

%it is critical to maximize capacity and
